        ...
        enlivenEm: function(callback) {
            return this.each(function() {
                ...
                function onSvgReady(){
                    ...
                    var grams = $parent.parents('#new_shows_first .et_pb_module:last-child');

                    grams.mouseenter(function() {
                        console.log(grams);
                        repeatAnimation();
                    });

                    var grams1 = $parent.parents('#home_phasellus_and_team_section .et_pb_column_8 .et_pb_image ');

                    grams1.mouseenter(function() {
                        repeatAnimation();
                    });


                    var grams2 = $parent.parents('#home_snap_shot_section .et_pb_column_17 .et_pb_image ');

                    grams2.mouseenter(function() {
                        repeatAnimation();
                    });

                    var grams3 = $parent.parents('#home_partners_and_phasellus_section .et_pb_column_24 .et_pb_image ');

                    grams3.mouseenter(function() {
                        repeatAnimation();
                    });
